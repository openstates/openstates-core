    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateTimeField()),
                ('end_time', models.DateTimeField()),
                ('plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scrapers', to='pupa.RunPlan')),
            ],
        ),
        migrations.CreateModel(
            name='ScrapeObjects',
            fields=[
                ...
                ('report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scraped_objects', to='pupa.ScrapeReport')),
            ],
        ),
        migrations.CreateModel(
            name='ImportObjects',
            fields=[
                ...
                ('start_time', models.DateTimeField()),
                ('end_time', models.DateTimeField()),
                ('report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='imported_objects', to='pupa.RunPlan')),
            ],
        ),
        migrations.CreateModel(
            name='Identifier',
